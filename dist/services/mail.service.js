...
class MailService {
    ...
    async send(subject, content, recipient, from) {
        ...
        if (!recipient || recipient.length < 1)
            throw new HttpException_1.default(400, 'Recipient is required');
        if (!subject)
            throw new HttpException_1.default(400, 'Subject is required');
        ...
        if (!result)
            throw new HttpException_1.default(500, 'Unable to send mail');
        return result;
    }
